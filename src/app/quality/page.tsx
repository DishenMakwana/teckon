                ...
                <div key={step.num} className="flex gap-6 items-start">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex-1 hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-[#FFBE00] font-black text-3xl">
                        {step.num}
                      </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {certs.map((cert) => (
              <div
                key={cert.title}
                className="text-center bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:border-teckon-blue hover:shadow-md transition-all"
              >
                <div className="text-5xl mb-4">{cert.icon}</div>
                <h3 className="font-black text-teckon-blue mb-2">
                  {cert.title}
                </h3>
