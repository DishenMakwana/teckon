...
export default function DiagnosticsBench() {
  ...
  const cylinderDims = useMemo(() => {
    ...
    // Rod Tip X
    const rodTipX = barrelX + barrelWidth + endCapWidth + extension * pistonRange;
          ...
          <div className="lg:col-span-6 bg-slate-900/90 rounded-3xl border border-white/10 p-5 sm:p-6 flex flex-col justify-between relative shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4 relative z-10">
                <span className="text-white font-black text-sm tracking-wider uppercase font-mono flex items-center gap-2">
                  <span className={`h-2.5 w-2.5 rounded-full ${isSimulating ? "bg-[#FF6B35] animate-ping" : "bg-emerald-500"} inline-block`} />
                  READOUT TELEMETRY
                </span>
                <span className="text-[#FFBE00] font-mono text-[10px] bg-[#FFBE00]/10 border border-[#FFBE00]/20 rounded-md px-2 py-0.5 font-bold tracking-widest">
                  {isSimulating ? `RUNNING (x${(1 / Math.max(0.3, stats.extendTimeSec)).toFixed(1)}Hz)` : "CONSOLE READY"}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center pt-2 pb-4 relative z-10">
                ...
                <div className="md:col-span-5 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-white/5 pb-6 md:pb-0 md:pr-4">
                  <svg width="170" height="135" viewBox="0 0 220 150" className="drop-shadow-[0_0_12px_rgba(255,190,0,0.15)] overflow-visible">
                    {/* Outer circle track */}
                    <path
                    ...
                    {/* Ticks & Text */}
                    <text x="20" y="115" fill="rgba(255,255,255,0.3)" fontSize="10" fontFamily="monospace" textAnchor="middle">0</text>
                    <text x="110" y="20" fill="rgba(255,255,255,0.3)" fontSize="10" fontFamily="monospace" textAnchor="middle">200</text>
                    <text x="200" y="115" fill="rgba(255,255,255,0.3)" fontSize="10" fontFamily="monospace" textAnchor="middle">400</text>
                    
                    <text x="110" y="78" fill="white" fontSize="30" fontWeight="900" fontFamily="monospace" textAnchor="middle" className="tracking-tight select-none">
                      {values.pressure}
                    </text>
                    <text x="110" y="93" fill="rgba(255,255,255,0.4)" fontSize="9" fontFamily="monospace" textAnchor="middle" letterSpacing="1">
                      BAR PRESSURE
                    </text>
                    ...
                    <g transform={`translate(110, 110)`}>
                      <motion.g
                        ...
                        transition={{ type: "spring", stiffness: 85, damping: 14, mass: 0.7 }}
                      >
                      ...
                      <circle cx="0" cy="0" r="9" fill="#0B0F19" stroke="#FFBE00" strokeWidth="2.5" />
                    </g>
                ...
                <div className="md:col-span-7 flex flex-col items-center justify-center">
                  <div className="w-full max-w-[270px] aspect-[320/140] relative bg-black/40 border border-white/5 rounded-2xl p-1.5 overflow-hidden">
                    ...
                    <svg viewBox="0 0 320 140" className="w-full h-full select-none overflow-visible">
                      <defs>
                        <linearGradient id="high-press-grad" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#FF6B35" stopOpacity="0.5" />
                          <stop offset="100%" stopColor="#FFBE00" stopOpacity="0.2" />
                        </linearGradient>
                        <linearGradient id="low-press-grad" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#3B82F6" stopOpacity="0.4" />
                          <stop offset="100%" stopColor="#10B981" stopOpacity="0.15" />
                        </linearGradient>
                        <linearGradient id="idle-press-grad" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#1E293B" stopOpacity="0.25" />
                          <stop offset="100%" stopColor="#0B0F19" stopOpacity="0.05" />
                        </linearGradient>
                      ...
                      <line x1="0" y1="35" x2="320" y2="35" stroke="rgba(255,255,255,0.02)" strokeDasharray="2 2" />
                      <line x1="0" y1="65" x2="320" y2="65" stroke="rgba(255,255,255,0.04)" strokeDasharray="3 3" />
                      <line x1="0" y1="95" x2="320" y2="95" stroke="rgba(255,255,255,0.02)" strokeDasharray="2 2" />
                      <line x1="35" y1="0" x2="35" y2="140" stroke="rgba(255,255,255,0.02)" strokeDasharray="2 2" />
                      <line x1="120" y1="0" x2="120" y2="140" stroke="rgba(255,255,255,0.02)" strokeDasharray="2 2" />
                      <line x1="200" y1="0" x2="200" y2="140" stroke="rgba(255,255,255,0.02)" strokeDasharray="2 2" />

                      {/* 1. Cap End Clevis Mount */}
                      <circle cx="20" cy={cylinderDims.centerY} r="9" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
                      <circle cx="20" cy={cylinderDims.centerY} r="4.5" fill="#0B0F19" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
                      <rect x="29" y={cylinderDims.centerY - 5} width="6" height="10" fill="url(#metal-grad)" stroke="rgba(255,255,255,0.2)" strokeWidth="0.5" />

                      {/* 2. Cap End Cylinder Cap (Rear cap) */}
                      <rect
                        x={cylinderDims.barrelX}
                        y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 - 2}
                      ...
                      <rect
                        ...
                        y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 + 1}
                        width={Math.max(0, cylinderDims.pistonX - (cylinderDims.barrelX + cylinderDims.endCapWidth))}
                        height={cylinderDims.barrelHeight - 2}
                        fill={isSimulating ? (direction > 0 ? "url(#high-press-grad)" : "url(#low-press-grad)") : "url(#idle-press-grad)"}
                      />
                      ...
                      <rect
                        ...
                        y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 + 1}
                        width={Math.max(0, (cylinderDims.barrelX + cylinderDims.barrelWidth) - (cylinderDims.pistonX + cylinderDims.pistonWidth))}
                        height={cylinderDims.barrelHeight - 2}
                        fill={isSimulating ? (direction < 0 ? "url(#high-press-grad)" : "url(#low-press-grad)") : "url(#idle-press-grad)"}
                      />
                      ...
                      <rect
                        ...
                        width={cylinderDims.barrelWidth - cylinderDims.endCapWidth}
                      ...
                      <rect
                        ...
                        width={Math.max(0, cylinderDims.rodTipX - (cylinderDims.pistonX + cylinderDims.pistonWidth))}
                      ...
                      />
                      {/* Piston Wear rings */}
                      <rect x={cylinderDims.pistonX + 3} y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 + 1} width="4" height="2" fill="#1e293b" />
                      <rect x={cylinderDims.pistonX + 3} y={cylinderDims.centerY + cylinderDims.barrelHeight / 2 - 3} width="4" height="2" fill="#1e293b" />
                      ...
                      <circle cx={cylinderDims.rodTipX + 8} cy={cylinderDims.centerY} r="8" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
                      <circle cx={cylinderDims.rodTipX + 8} cy={cylinderDims.centerY} r="3.5" fill="#0B0F19" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
                      <rect x={cylinderDims.rodTipX} y={cylinderDims.centerY - 4} width="5" height="8" fill="url(#rod-grad)" stroke="rgba(255,255,255,0.2)" strokeWidth="0.5" />

                      {/* 10. Oil Ports */}
                      {/* Port A (Cap End) */}
                      <rect x={cylinderDims.barrelX + cylinderDims.endCapWidth + 8} y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 - 5} width="6" height="5" fill="url(#metal-grad)" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                      {/* Port B (Rod End) */}
                      <rect x={cylinderDims.barrelX + cylinderDims.barrelWidth - 14} y={cylinderDims.centerY - cylinderDims.barrelHeight / 2 - 5} width="6" height="5" fill="url(#metal-grad)" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
                      ...
                      {isSimulating && (
                        <>
                          {direction > 0 ? (
                            ...
                            <>
                              <path d="M 52 35 L 52 40 M 50 38 L 52 40 L 54 38" stroke="#FF6B35" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M 124 40 L 124 35 M 122 37 L 124 35 L 126 37" stroke="#3B82F6" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                            </>
                          ) : (
                            /* Retracting: Oil out Port A, Oil in Port B */
                            <>
                              <path d="M 52 40 L 52 35 M 50 37 L 52 35 L 54 37" stroke="#3B82F6" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M 124 35 L 124 40 M 122 38 L 124 40 L 126 38" stroke="#FF6B35" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                            </>
                          )}
                        </>
                      )}
                      ...
                      {/* Bore Dimension (Left) */}
                      <line x1="14" y1={cylinderDims.centerY - cylinderDims.barrelHeight / 2} x2="14" y2={cylinderDims.centerY + cylinderDims.barrelHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" strokeDasharray="1.5 1.5" />
                      <line x1="11" y1={cylinderDims.centerY - cylinderDims.barrelHeight / 2} x2="17" y2={cylinderDims.centerY - cylinderDims.barrelHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <line x1="11" y1={cylinderDims.centerY + cylinderDims.barrelHeight / 2} x2="17" y2={cylinderDims.centerY + cylinderDims.barrelHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <text x="8" y={cylinderDims.centerY + 3} fill="#FFBE00" fontSize="7.5" fontFamily="monospace" fontWeight="bold" textAnchor="end" opacity="0.8">
                        D:{values.bore}
                      </text>

                      {/* Rod Dimension (Right) */}
                      <line x1={cylinderDims.rodTipX + 22} y1={cylinderDims.centerY - cylinderDims.rodHeight / 2} x2={cylinderDims.rodTipX + 22} y2={cylinderDims.centerY + cylinderDims.rodHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" strokeDasharray="1.5 1.5" />
                      <line x1={cylinderDims.rodTipX + 19} y1={cylinderDims.centerY - cylinderDims.rodHeight / 2} x2={cylinderDims.rodTipX + 25} y2={cylinderDims.centerY - cylinderDims.rodHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <line x1={cylinderDims.rodTipX + 19} y1={cylinderDims.centerY + cylinderDims.rodHeight / 2} x2={cylinderDims.rodTipX + 25} y2={cylinderDims.centerY + cylinderDims.rodHeight / 2} stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <text x={cylinderDims.rodTipX + 27} y={cylinderDims.centerY + 3} fill="#FFBE00" fontSize="7.5" fontFamily="monospace" fontWeight="bold" textAnchor="start" opacity="0.8">
                        d:{values.rod}
                      </text>

                      {/* Stroke Dimension (Bottom) */}
                      <line x1={cylinderDims.barrelX + cylinderDims.endCapWidth} y1="120" x2={cylinderDims.barrelX + cylinderDims.barrelWidth} y2="120" stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" strokeDasharray="1.5 1.5" />
                      <line x1={cylinderDims.barrelX + cylinderDims.endCapWidth} y1="117" x2={cylinderDims.barrelX + cylinderDims.endCapWidth} y2="123" stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <line x1={cylinderDims.barrelX + cylinderDims.barrelWidth} y1="117" x2={cylinderDims.barrelX + cylinderDims.barrelWidth} y2="123" stroke="rgba(255,190,0,0.4)" strokeWidth="0.75" />
                      <text x={cylinderDims.barrelX + cylinderDims.barrelWidth / 2} y="131" fill="#FFBE00" fontSize="7.5" fontFamily="monospace" fontWeight="bold" textAnchor="middle" opacity="0.8">
                        S:{values.stroke}mm
                      </text>
                    </svg>
                    ...
                    <div className="absolute bottom-2 right-2 bg-[#0B0F19]/90 border border-white/5 rounded px-1.5 py-0.5 font-mono text-[8px] text-slate-400 select-none">
                      {isSimulating ? (direction > 0 ? "STATE: EXPAND" : "STATE: RETRACT") : "STATE: HOLD"}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setExtension(parseFloat(e.target.value) / 100)}
                    ...
                    />
                    <span className={`text-[10px] font-mono font-bold w-10 text-right ${isSimulating ? "text-slate-500" : "text-[#10B981]"}`}>
