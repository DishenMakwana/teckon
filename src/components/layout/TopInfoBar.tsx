    ...
    <div className="bg-teckon-dark-blue text-white text-sm py-2.5 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-0">
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center">
          <a href="mailto:shreejihyd4008@gmail.com" className="flex items-center gap-2 hover:text-[#FFBE00] transition-colors font-medium">
            <Mail size={15} className="text-[#FFBE00]" />
            <span>shreejihyd4008@gmail.com</span>
          </a>
          <span className="hidden sm:inline text-white/20">|</span>
          <a href="tel:+916351879842" className="flex items-center gap-2 hover:text-[#FFBE00] transition-colors font-medium">
            <Phone size={15} className="text-[#FFBE00]" />
